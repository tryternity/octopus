...
|--------|-----------|---------|------|---------|
| **result_window**（精简态） | 顶部 720×116 小条 | 小条下方透明区 | `start_click_through_poller`（`result_window.rs`） | `cursor_position()` 物理坐标 |
