...
- [ ] **Step 1: 加 Source::Ocr + as_str/from_str（含失败测试）**
...
- [ ] **Step 4: 加 OcrMeta + ClipboardItem.ocr_meta**
...
- [ ] **Step 1: 写 insert_ocr_item + build_where + row_to_item 的失败测试**
...
- [ ] **Step 5: row_to_item 反序列化 ocr_meta**
...
- [ ] **Step 1: 删 notepad crate + desktop 依赖**
...
- [ ] **Step 6: compact_editor_window.rs 更新注释**
...
- [ ] **Step 3: HistoryPanel.tsx 移除「保存为笔记」按钮**
...
- [ ] **Step 4: capability 移除 notepad_window**
...
- [ ] **Step 1: 重写 compact_editor_commands.rs（item_id 驱动）**
...
- [ ] **Step 2: 新增 get_clipboard_item_text 命令**
...
- [ ] **Step 1: 重写 lib/compactEditor.ts**
...
- [ ] **Step 2: 重写 pages/CompactEditor/index.tsx 为多 tab**
...
- [ ] **Step 3: ClipboardItem.tsx handleEditText 改为开 tab**
...
- [ ] **Step 1: 新增 insert_ocr_clipboard_item 命令**
...
- [ ] **Step 3: main.rs 注册 insert_ocr_clipboard_item**
...
- [ ] **Step 2: FilterTabs.tsx 加 OCR tab**
...
- [ ] **Step 3: ClipboardItem.tsx OCR 来源标记**
...
- **Spec 覆盖**：§4 记事本清除 → Task 3/4/5；§5 多 tab → Task 6/7；§6 OCR 统一 → Task 8/9；§7 OCR 类别 → Task 1/2/10；文档 → Task 11。全覆盖。
