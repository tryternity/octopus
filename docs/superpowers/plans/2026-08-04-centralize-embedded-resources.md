...
- [ ] **Step 2: 加 public_suffix_list() 到 resources.rs**
...
- [ ] **Step 3: vault/Cargo.toml 加 infra 依赖**
...
- [ ] **Step 2: 加 ocr_words_common() 到 resources.rs**
...
- [ ] **Step 3: ocr/Cargo.toml 加 infra 依赖**

```toml
octopus-infra = { path = "../infra" }
```

- [ ] **Step 4: 改 engine.rs 消费点**
...
- [ ] **Step 2: 加 4 个 fn 到 resources.rs**
