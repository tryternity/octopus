...
impl DispatchEngine {
    pub fn new(engine_manager: Arc<octopus_asr::engine::AsrEngineManager>) -> Self {
        Self {
            ...
            dashscope: crate::engine_dashscope::DashscopeEngine::new(),
        }
    }
}
