  ...
  return (
    <div className="max-w-[640px]">
      ...
      <div className="flex items-center gap-0 mb-4 border-b border-border">
        {([
          ["general", t("settings.general.tabGeneral")],
          ["shortcut", t("settings.general.tabShortcut")],
          ["voice", t("settings.general.tabVoice")],
          ...
          >
            {label}
            {activeTab === key && (
              <span className="absolute bottom-[-1px] left-0 right-0 h-[2px] bg-voice rounded-full" />
            )}
          </button>
        ))}
      </div>
