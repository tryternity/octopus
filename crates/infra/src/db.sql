...
VALUES
    ...
    ('asr','local','zipformer','zipformer-zh-transducer','csukuangfj/sherpa-onnx-streaming-zipformer-zh-int8-2025-06-30','zh','zipformer Transducer (RNN-T), 154M',1,0,0),
    ('asr','local','zipformer','zipformer-xlarge-transducer','csukuangfj/sherpa-onnx-streaming-zipformer-zh-xlarge-int8-2025-06-30','zh','zipformer Transducer xlarge (RNN-T), 726M',1,0,0),
